...
const IssueCard: React.FC<IssueCardProps> = ({ name, priority, editAction, deleteAction, color, className, id }) => {
  ...
  return (
    <div className={classes} id={id}>
      <div className='issue-card__info'>
        <h3 className='issue-card__name'>Issue: {!name ? 'unknown' : name}</h3>
